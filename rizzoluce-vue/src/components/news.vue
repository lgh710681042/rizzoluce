    ...
    <div class="h100">
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><router-link class="nav-item-child nav-item-hover active" to="/news">News</router-link></li>
        ...
        <div class="parallax-window" data-parallax="scroll" :data-image-src="img">
            <div class="parallax-content container">
                <h1 class="carousel-title">NEWS</h1>
            </div>
        </div>
        <!--========== PARALLAX ==========-->
        ...
        <div class="content-lg container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-1">
                    <img class="img-responsive" src="../assets/img/640x380/01.jpg" alt="Our Office">
                </div>
            </div>
            <!--// end row -->
        </div>
