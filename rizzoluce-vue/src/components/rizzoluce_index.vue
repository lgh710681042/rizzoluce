        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="img-responsive" src="../assets/img/1920x1080/01.jpg" alt="Slider Image">
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">#la bella luce.</h1>
                            </div>
                ...
                <div class="item">
                    <img class="img-responsive" src="../assets/img/1920x1080/02.jpg" alt="Slider Image">
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h2 class="carousel-title">#la bella luce.</h2>
                            </div>
                            <a href="#" class="btn-theme btn-theme-sm btn-white-brd text-uppercase">Explore</a>
                        </div>
                    </div>
                ...
                <div class="item">
                    <img class="img-responsive" src="../assets/img/1920x1080/06.jpg" alt="Slider Image">
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h2 class="carousel-title">#la bella luce.</h2>
                ...
                <div class="item">
                    <img class="img-responsive" src="../assets/img/1920x1080/04.jpg" alt="Slider Image">
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h2 class="carousel-title">#la bella luce.</h2>
                ...
                <div class="item">
                    <img class="img-responsive" src="../assets/img/1920x1080/05.jpg" alt="Slider Image">
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h2 class="carousel-title">#la bella luce.</h2>
                ...
                <div class="row row-space-1 margin-b-2">
                    <div class="col-sm-4 sm-margin-b-2">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            ...
                            <a href="#">
                                <img class="img-responsive" src="" alt="Our Exceptional Solutions Image">
                            </a>
                                ...
                                <div class="service-info">
                                    ...
                                    <img class="img-responsive" src="img/test.jpg" alt="Our Exceptional Solutions Image">
                                </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="" alt="Latest Products Image">
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8">
                        ...
                        <div class="work wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="../assets/img/800x400/01.jpg" alt="Portfolio Image">
                            </div>
            ...
            <div class="content container">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <!-- <p class="margin-b-0"><a class="color-base fweight-700" href="#preview/asentus/">Asentus</a> More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p> -->

                        <p class="margin-b-0">© Copyright 2018 Rizzoluce</p>
                    </div>
                </div>
                <!--// end row © Copyright 2018 Rizzoluce-->
            </div>
            <!-- End Copyright -->
        </footer>
        <!--========== END FOOTER ==========-->
